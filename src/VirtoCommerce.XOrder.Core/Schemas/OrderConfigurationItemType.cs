...
public class OrderConfigurationItemType : ExtendableGraphType<ConfigurationItem>
{
    public OrderConfigurationItemType()
    {
        ...
        ExtendableField<ListGraphType<OrderConfigurationItemFileType>>(nameof(ConfigurationItem.Files), resolve: context => context.Source.Files, description: "List of files for 'File'-type configuration item section");
    }
}
